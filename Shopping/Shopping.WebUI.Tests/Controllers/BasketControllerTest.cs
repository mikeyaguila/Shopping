...
using Shopping.WebUI.Controllers;
using Shopping.WebUI.Tests.Mocks;

namespace Shopping.WebUI.Tests.Controllers
{
    [TestClass]
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "mlaguila@mail.com", ZipCode = "20451" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("mlaguila@mail.com","Forms"), null);
